    ...
    return (
        <>
            ...
            <div className="w-1/2 h-1/16 rounded-4xl bg-white/15 backdrop-blur-xl border border-white/30 p-6 flex flex-col justify-center items-center">
                <h1 className="text-black text-2xl font-semibold">Welcome, {name}</h1>
            </div>

                <div className="w-1/2 h-1/3 rounded-4xl bg-white/15 backdrop-blur-xl border border-white/30 p-6 flex flex-col">
                    <div className="w-full h-full flex ">
                        <div className="w-2/8 h-full  flex justify-center items-center">
                            <label
                                className="w-24 h-24 rounded-full bg-white/20 border border-white/30 backdrop-blur-md flex items-center justify-center cursor-pointer overflow-hidden shadow-lg" >
                                {preview ? (
                                    <img
                                        src={preview}
                                        alt="Profile preview"
