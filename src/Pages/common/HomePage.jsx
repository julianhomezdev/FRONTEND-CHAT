        ...
        <div className="w-full h-screen  flex p-0">
            ...
            <div className="w-1/2 h-screen  flex items-center justify-center pl-10">
                <div className="w-full h-3/3  flex justify-center p-10  flex-col">
                    ...
                    <button className=" w-1/3 px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-700 text-white font-semibold rounded-full shadow-lg hover:scale-105 hover:shadow-xl transition-transform duration-300 cursor-pointer mt-4.5">Start talking</button>
